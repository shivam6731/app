...
public class Stop implements MapDetailsProvider {
    ...
    /**
     * Generated by Parcelable android plugin
     */
    public Stop() {
    }
     ...
     *
     * @param id        order id
     * @param orderCode orders code should follow pattern xxxx-yyyy
     *                  where xxxx-vendor code and yyyy- customer code
     */
    public Stop(int id, String orderCode) {
        this.id = id;
